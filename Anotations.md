...
- Actualización del README del backend para incluir instrucciones precisas sobre la ejecución de Rails 8 en entornos Windows, abarcando Rubyinstaller, dependencias de MSYS2 y comandos en PowerShell.
